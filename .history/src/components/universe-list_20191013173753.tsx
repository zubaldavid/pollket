        ...
        <StyledWidthConstraintDiv>
          ...
          <StyledUniverses>
            {universeData.length > 0 ? (
              universeData.map((data: IUniverse, idx: string) => {
                return (
                  <StyledUniverseButton onClick={chooseUniverse} key={idx}>
                    <StyledLabel> {data ? data.name : null}</StyledLabel>
                    <StyledP> {data ? data.date : null}</StyledP>
              ...
              <>
                ...
                <br />
                <StyledButton><a href='https://www.politicaldata.com'>Make a Universe</StyledButton>
              </>
            )}
          </StyledUniverses>
        </StyledWidthConstraintDiv>
